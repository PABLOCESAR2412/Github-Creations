...
export const DynamicStatsConfigurator: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Controls */}
        <div className="col-span-1 space-y-6 bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black p-5 border border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 brutal-shadow font-mono">
          
          <div>
            <h3 className="text-sm font-bold text-black dark:text-black dark:text-white mb-3 flex items-center gap-2 uppercase tracking-widest">
              <LayoutGrid className="w-4 h-4 text-[#00ffff]" /> [ LAYOUT_DESIGN ]
            </h3>
            <div className="grid grid-cols-2 gap-2 mb-4">
              <button 
                onClick={() => setLayout('neon-cluster')}
                className={`p-2 border text-xs font-bold uppercase transition-all ${layout === 'neon-cluster' ? 'bg-[#00ffff] border-[#00ffff] text-black' : 'bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 text-zinc-600 dark:text-zinc-600 dark:text-zinc-400 hover:border-zinc-500'}`}
              >
                NEON CLUSTER
              </button>
              <button 
                onClick={() => setLayout('data-matrix')}
                className={`p-2 border text-xs font-bold uppercase transition-all ${layout === 'data-matrix' ? 'bg-[#00ffff] border-[#00ffff] text-black' : 'bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 text-zinc-600 dark:text-zinc-600 dark:text-zinc-400 hover:border-zinc-500'}`}
              >
                DATA MATRIX
              </button>
            </div>

            <h3 className="text-sm font-bold text-black dark:text-black dark:text-white mb-3 mt-5 uppercase tracking-widest">[ BADGE_STYLE ]</h3>
            <select 
              value={badgeStyle} 
              onChange={(e) => setBadgeStyle(e.target.value)}
              className="w-full bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 text-black dark:text-black dark:text-white px-3 py-2 text-sm focus:border-[#00ffff] outline-none uppercase"
            >
          ...
          <div>
            <h3 className="text-sm font-bold text-black dark:text-black dark:text-white mb-3 uppercase tracking-widest">[ CUSTOM_COLORS ]</h3>
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center gap-1">
                <input 
                  ...
                  className="w-10 h-10 cursor-pointer bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 p-1"
                />
                <span className="text-[10px] text-zinc-600 dark:text-zinc-600 dark:text-zinc-400 uppercase">LABEL BG</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <input 
                  type="color" 
                  ...
                  className="w-10 h-10 cursor-pointer bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 p-1"
                />
                <span className="text-[10px] text-zinc-600 dark:text-zinc-600 dark:text-zinc-400 uppercase">VALUE BG</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <input 
                  type="color" 
                  ...
                  className="w-10 h-10 cursor-pointer bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 p-1"
                />
                <span className="text-[10px] text-zinc-600 dark:text-zinc-600 dark:text-zinc-400 uppercase">ICON COLOR</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {availableStats.map(s => (
                <label key={s.id} className="flex items-center justify-between p-2 bg-white dark:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 cursor-pointer hover:border-zinc-300 dark:border-zinc-300 dark:border-zinc-700 transition-colors uppercase">
                  <span className="text-xs font-bold text-black dark:text-black dark:text-white">{s.label}</span>
                  <input 
                    type="checkbox" 
          ...
          <div className="pt-4 border-t border-zinc-300 dark:border-zinc-300 dark:border-zinc-800">
            <button
        ...
        {/* Live Preview Area */}
        <div className="col-span-1 lg:col-span-2 bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 flex flex-col p-6 overflow-hidden relative brutal-shadow">
          <div className="absolute top-4 left-4 text-[10px] font-mono text-[#00ffff] bg-white dark:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 px-2 py-1 uppercase tracking-widest font-bold">
          ...
          <div className="mt-6 w-full bg-white dark:bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 p-4 overflow-auto">
            <div className="text-[10px] text-zinc-600 dark:text-zinc-600 dark:text-zinc-500 uppercase tracking-widest font-bold mb-2">&gt; RAW_MARKDOWN_HTML</div>
  ...
  return (
    <div className="bg-[#f5f4ef] dark:bg-[#f5f4ef] dark:bg-black border border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 p-6 shadow-2xl space-y-6 brutal-shadow">
      <div className="flex items-center justify-between border-b border-zinc-300 dark:border-zinc-300 dark:border-zinc-800 pb-4">
        <div className="flex items-center gap-4">
          <div className="p-2.5 bg-[#00ffff] text-black border border-black dark:border-black dark:border-white">
