...
const Navigation = () => {
  ...
  return (
    <header className="border-b border-zinc-800 bg-black sticky top-0 z-50 px-6 py-4 flex items-center justify-between font-mono uppercase tracking-widest text-sm">
      <div className="flex items-center gap-4">
        <Link to="/">
          <motion.div
            className="w-12 h-12 bg-black border-2 border-white flex items-center justify-center brutal-shadow transition-transform"
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-zinc-500 mt-1 lowercase">
      ...
      <div className="flex items-center gap-6 text-xs font-bold text-zinc-400">
        ...
        <div className="flex items-center gap-2 border border-zinc-800 px-3 py-1.5 bg-zinc-950">
          ...
          <span className="text-zinc-300">TAURI2</span>
        </div>
      </div>
    </header>
  );
...
export function App() {
  return (
    <Router>
      <div className="min-h-screen bg-black text-white flex flex-col font-mono selection:bg-[#00ffff] selection:text-black overflow-x-hidden">
        <Navigation />
        ...
        {/* Footer */}
        <footer className="border-t border-zinc-900 px-6 py-4 text-center text-xs text-zinc-600 flex items-center justify-between mt-auto bg-black uppercase tracking-wider">
